module.exports = class Data1666092743784 {
  name = 'Data1666092743784'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "collection_entity" ("version" text, "name" text, "max" integer NOT NULL, "issuer" text, "symbol" text, "id" character varying NOT NULL, "metadata" text, "events" jsonb, "block_number" numeric, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "current_owner_id" character varying, "meta_id" character varying, CONSTRAINT "PK_5d44e140c4fcb3d961f9e83405f" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_b0d709797451c6237e8ec0fee8" ON "collection_entity" ("name") `)
    await db.query(`CREATE INDEX "IDX_5c0dea8fa70634098bbd5924a5" ON "collection_entity" ("current_owner_id") `)
    await db.query(`CREATE INDEX "IDX_014542183f297493eab0cd8bdf" ON "collection_entity" ("meta_id") `)
    await db.query(`CREATE TABLE "event" ("id" character varying NOT NULL, "block_number" numeric, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "interaction" character varying(12) NOT NULL, "meta" text NOT NULL, "caller_id" character varying, "current_owner_id" character varying, "nft_id" character varying, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_4bfb96e903875120d68c3c32d3" ON "event" ("caller_id") `)
    await db.query(`CREATE INDEX "IDX_3c2363e1a23fe40e834da2492a" ON "event" ("current_owner_id") `)
    await db.query(`CREATE INDEX "IDX_9380d479563e5a664759359470" ON "event" ("nft_id") `)
    await db.query(`CREATE TABLE "nft_entity" ("name" text, "instance" text, "transferable" integer, "issuer" text, "sn" text, "id" character varying NOT NULL, "hash" text NOT NULL, "metadata" text, "price" numeric NOT NULL, "burned" boolean NOT NULL, "block_number" numeric, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "emote_count" integer NOT NULL, "collection_id" character varying, "current_owner_id" character varying, "meta_id" character varying, CONSTRAINT "PK_ed09c6a38c0f0a867d5a7b63f0d" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_149a8d37a1c1ac6f231ea7d89a" ON "nft_entity" ("current_owner_id") `)
    await db.query(`CREATE INDEX "IDX_2bfc45b91959a14ab8b2d734cd" ON "nft_entity" ("meta_id") `)
    await db.query(`CREATE TABLE "emote" ("id" character varying NOT NULL, "value" text NOT NULL, "nft_id" character varying, "caller_id" character varying, CONSTRAINT "PK_c08d432f6b22ef550be511163ac" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_463234b85d428ddde1bce27182" ON "emote" ("nft_id") `)
    await db.query(`CREATE INDEX "IDX_54f8132419c8d9386555146517" ON "emote" ("caller_id") `)
    await db.query(`CREATE TABLE "account_entity" ("id" character varying NOT NULL, "avatar" text, "handle" text, "background" text, "last_update_block" integer NOT NULL, CONSTRAINT "PK_b482dad15becff9a89ad707dcbe" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "remark_entity" ("id" character varying NOT NULL, "value" text NOT NULL, "block_number" text NOT NULL, "interaction" text, "caller_id" character varying, CONSTRAINT "PK_47fe6cc1a357ef713548bfb9c9c" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_bdfd9a34262beec56e920bc253" ON "remark_entity" ("caller_id") `)
    ...
    await db.query(`ALTER TABLE "collection_entity" ADD CONSTRAINT "FK_5c0dea8fa70634098bbd5924a59" FOREIGN KEY ("current_owner_id") REFERENCES "account_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "event" ADD CONSTRAINT "FK_4bfb96e903875120d68c3c32d35" FOREIGN KEY ("caller_id") REFERENCES "account_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "event" ADD CONSTRAINT "FK_3c2363e1a23fe40e834da2492ae" FOREIGN KEY ("current_owner_id") REFERENCES "account_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "nft_entity" ADD CONSTRAINT "FK_149a8d37a1c1ac6f231ea7d89ad" FOREIGN KEY ("current_owner_id") REFERENCES "account_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "emote" ADD CONSTRAINT "FK_54f8132419c8d9386555146517a" FOREIGN KEY ("caller_id") REFERENCES "account_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "remark_entity" ADD CONSTRAINT "FK_bdfd9a34262beec56e920bc2533" FOREIGN KEY ("caller_id") REFERENCES "account_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_5c0dea8fa70634098bbd5924a5"`)
    await db.query(`DROP INDEX "public"."IDX_014542183f297493eab0cd8bdf"`)
    await db.query(`DROP TABLE "event"`)
    await db.query(`DROP INDEX "public"."IDX_4bfb96e903875120d68c3c32d3"`)
    await db.query(`DROP INDEX "public"."IDX_3c2363e1a23fe40e834da2492a"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_149a8d37a1c1ac6f231ea7d89a"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_54f8132419c8d9386555146517"`)
    await db.query(`DROP TABLE "account_entity"`)
    await db.query(`DROP TABLE "remark_entity"`)
    await db.query(`DROP INDEX "public"."IDX_bdfd9a34262beec56e920bc253"`)
    ...
    await db.query(`ALTER TABLE "collection_entity" DROP CONSTRAINT "FK_5c0dea8fa70634098bbd5924a59"`)
    await db.query(`ALTER TABLE "collection_entity" DROP CONSTRAINT "FK_014542183f297493eab0cd8bdf8"`)
    await db.query(`ALTER TABLE "event" DROP CONSTRAINT "FK_4bfb96e903875120d68c3c32d35"`)
    await db.query(`ALTER TABLE "event" DROP CONSTRAINT "FK_3c2363e1a23fe40e834da2492ae"`)
    ...
    await db.query(`ALTER TABLE "nft_entity" DROP CONSTRAINT "FK_149a8d37a1c1ac6f231ea7d89ad"`)
    ...
    await db.query(`ALTER TABLE "emote" DROP CONSTRAINT "FK_54f8132419c8d9386555146517a"`)
    await db.query(`ALTER TABLE "remark_entity" DROP CONSTRAINT "FK_bdfd9a34262beec56e920bc2533"`)
  }
}
