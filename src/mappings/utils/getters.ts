...
export function getRemark<T = InteractionValue>(
  ctx: Context
): UnwrappedRemark<T | InteractionValue> {
...
export function getInteraction(
  ctx: Context
): UnwrappedRemark<InteractionValue> {
...
export function getInteractionWithExtra(
  ctx: Context
): UnwrappedRemark<InteractionValue> & InteractionExtra {
  const { value, ...rest } = getRemark<InteractionValue>(ctx)
